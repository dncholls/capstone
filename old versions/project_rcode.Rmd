...
cols <- c("Outcome.Type", "Outcome.Subtype", "Sex.upon.Outcome", "Age.upon.Outcome",  "Outcome.Month", "Intake.Type", "Intake.Condition", "Found.Location", "Days.to.Outcome", "Purebred.or.Mixed", "Gender", "Gen.Color", "Gen.Group")
